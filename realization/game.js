...
console.log("C2: Function");
console.log("C3: Loops");
console.log("C4: condition");
console.log("C5: strings");
console.log("C6: committing changes in the git");
console.log("C7: linking the git to a github repository");
...
console.log('you scored ' + score + ' out of 8');
